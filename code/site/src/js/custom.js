...
$(function () {
	...
	//js for change tab from external link
	$('.link-to-tab').on('click', function (e) {
		var tabId = $(this).attr('href'); // Ottieni l'ID del tab dal valore dell'attributo href
		...
		$('.tab-links li a[href="' + tabId + '"]').parent('li').addClass('active');
